        ...
        <q-card @click="selectTodo(row)" class="q-mt-sm" v-for="row in MyTasks" :key="row.id">
          ...
          >
            ...
            <div class="bg-white q-pa-sm">
              <q-btn @click.stop="toggleDialog(row, 'mark-done')" 
              flat icon="check_circle_outline" color="green" />
              <q-btn @click.stop="toggleDialog(row, 'delete')"
              flat icon="delete_outline" color="red" />
